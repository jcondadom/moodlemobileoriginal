...
var AddonModBookTocPage = /** @class */ (function () {
    ...
    AddonModBookTocPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-addon-mod-book-toc',template:/*ion-inline-start:"C:\Users\jocondado\Desktop\Project\Ionic\moodlemobile2Nuevo\src\addon\mod\book\pages\toc\toc.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title>{{ \'addon.mod_book.toc\' | translate }}</ion-title>\n\n        <ion-buttons end>\n\n            <button ion-button icon-only (click)="closeModal()" [attr.aria-label]="\'core.close\' | translate">\n\n                <ion-icon name="close"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <nav>\n\n        <ion-list>\n\n            <a ion-item text-wrap *ngFor="let chapter of chapters" (click)="loadChapter(chapter.id)" [class.core-nav-item-selected]="selected == chapter.id">\n\n                <p [attr.padding-left]="chapter.level == 1 ? true : null">{{chapter.title}}</p>\n\n            </a>\n\n        </ion-list>\n\n    </nav>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\jocondado\Desktop\Project\Ionic\moodlemobile2Nuevo\src\addon\mod\book\pages\toc\toc.html"*/
        }),
