...
var CoreLoginCredentialsPage = /** @class */ (function () {
    ...
    CoreLoginCredentialsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-login-credentials',template:/*ion-inline-start:"C:\Users\jocondado\Desktop\Project\Ionic\moodlemobileOriginal\src\core\login\pages\credentials\credentials.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title>{{ \'core.login.login\' | translate }}</ion-title>\n\n\n\n        <ion-buttons end>\n\n            <button *ngIf="isFixedUrlSet" ion-button icon-only [navPush]="\'CoreSettingsListPage\'" [attr.aria-label]="\'core.mainmenu.appsettings\' | translate">\n\n                <ion-icon name="cog"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content class="core-center-view">\n\n    <core-loading [hideUntil]="pageLoaded">\n\n            <ion-row class="logo-row">\n\n                <ion-col></ion-col>\n\n                <ion-col width-167>\n\n                    \n\n                </ion-col>\n\n                <ion-col></ion-col>\n\n            </ion-row>\n\n        <div class="box">\n\n            <div text-wrap text-center margin-bottom>\n\n                <!-- Show site logo or a default image. \n\n                <img *ngIf="logoUrl" [src]="logoUrl" role="presentation">\n\n                <img *ngIf="!logoUrl" src="assets/img/init_logo.png" class="login-logo" role="presentation">-->\n\n\n\n                <!-- If no sitename show big siteurl. \n\n                <p *ngIf="!siteName" padding class="item-heading core-siteurl">{{siteUrl}}</p>-->\n\n                <!-- If sitename, show big sitename and small siteurl. \n\n                <p *ngIf="siteName" padding class="item-heading core-sitename"><core-format-text [text]="siteName"></core-format-text></p>\n\n                <p *ngIf="siteName" class="core-siteurl">{{siteUrl}}</p>-->\n\n            </div>\n\n            <form ion-list [formGroup]="credForm" (ngSubmit)="login($event)" class="core-login-form">\n\n                <ion-item *ngIf="siteChecked && !isBrowserSSO">\n\n                    <ion-label color="primary" position="floating"><ion-icon name="person"></ion-icon></ion-label>\n\n                    <ion-input type="text" name="username" placeholder="{{ \'core.login.username\' | translate | uppercase }}" formControlName="username" autocapitalize="none" autocorrect="off"></ion-input>\n\n                </ion-item>\n\n                <ion-item *ngIf="siteChecked && !isBrowserSSO" margin-bottom>\n\n                    <!--<core-show-password item-content [name]="\'password\'">-->\n\n                        <ion-label color="primary" position="floating"><ion-icon name="lock"></ion-icon></ion-label>\n\n                        <ion-input class="core-ioninput-password" name="password" type="password" placeholder="{{ \'core.login.password\' | translate | uppercase }}" formControlName="password" core-show-password [clearOnEdit]="false"></ion-input>\n\n                    <!--</core-show-password>-->\n\n                </ion-item>\n\n                <!-- Forgotten password button. -->\n\n                <div padding-top text-center>\n\n                    <a class="forgotten_password" (click)="forgottenPassword()">{{ \'core.login.forgotten\' | translate }}</a>\n\n                </div>\n\n                <button class="boton" [disabled]="siteChecked && !isBrowserSSO && !credForm.valid">{{ \'core.login.loginbutton\' | translate }}</button>\n\n            </form>\n\n\n\n            \n\n\n\n            <ion-list *ngIf="identityProviders && identityProviders.length" padding-top>\n\n                <ion-list-header text-wrap>{{ \'core.login.potentialidps\' | translate }}</ion-list-header>\n\n                <button class="radius" ion-item *ngFor="let provider of identityProviders" text-wrap class="core-oauth-icon" (click)="oauthClicked(provider)" title="{{provider.name}}">\n\n                    <img [src]="provider.iconurl" alt="" width="32" height="32" item-start>\n\n                    {{provider.name}}\n\n                </button>\n\n            </ion-list>\n\n\n\n            <ion-list *ngIf="canSignup" padding-top>\n\n                <ion-list-header text-wrap>{{ \'core.login.firsttime\' | translate }}</ion-list-header>\n\n                <ion-item no-lines text-wrap *ngIf="authInstructions">\n\n                    <p><core-format-text [text]="authInstructions"></core-format-text></p>\n\n                </ion-item>\n\n                <button class="boton" (click)="signup()">{{ \'core.login.startsignup\' | translate }}</button>\n\n            </ion-list>\n\n        </div>\n\n    </core-loading>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\jocondado\Desktop\Project\Ionic\moodlemobileOriginal\src\core\login\pages\credentials\credentials.html"*/,
        }),
